  ...
  return (
    <div className="min-h-screen bg-[#1f1e24] text-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row min-h-screen">
        ...
        {/* LEFT SECTION - text and service letters */}
        <div className="w-full md:w-[55%] px-6 md:px-12 pt-20 pb-10 md:pr-8">
          <h1 className="text-5xl font-bold text-[#6A63AF] mb-6">
            Resume
          </h1>
        ...
        {/* RIGHT SECTION - CV panel (stacks below on mobile) */}
        <div className="w-full md:w-[45%] md:sticky md:top-0 md:h-screen bg-[#1a191d] md:border-l md:border-[#6A63AF]/40 md:shadow-[-10px_0_30px_rgba(168,85,247,0.1)]">
          <div className="h-[60vh] md:h-full w-full">
            <iframe
              src="/Dhanushka Pradeep Munasinghe CV.pdf"
